...
const addCartToHTML = () => {
    ...
    totalHTML.innerHTML = `Total: <span>R${totalCost.toFixed(2)}</span>`;
};
...
function renderProducts(products) {
    ...
    // re-add event listeners for "Add to Cart" buttons
    const addCartButtons = productList.querySelectorAll('.addCart');
